    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('green', 'Green'), ('orange', 'Orange'), ('purple', 'Purple')], default='green', max_length=10, verbose_name='Цвет')),
            ],
            options={
                'verbose_name': 'Тег',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', sorl.thumbnail.fields.ImageField(help_text='Загрузите изображение', upload_to='recipes/', verbose_name='Загрузить фото')),
                ...
                ('ingredients', models.ManyToManyField(related_name='recipes', through='recipes.Composition', to='recipes.Ingredient', verbose_name='Ингредиенты')),
